...
// Hybrid Function 1
double hf01(std::vector<double>& x, std::vector<double>& aux,
            const std::vector<double>& shift,
            const std::vector<std::vector<double>>& rotate,
...
// Hybrid Function 2
double hf02(std::vector<double>& x, std::vector<double>& aux,
            const std::vector<double>& shift,
            const std::vector<std::vector<double>>& rotate,
            const std::vector<std::size_t>& indices, bool shift_flag,
            bool rotate_flag);
...
// Hybrid Function 3
double hf03(std::vector<double>& x, std::vector<double>& aux,
            const std::vector<double>& shift,
            const std::vector<std::vector<double>>& rotate,
            const std::vector<std::size_t>& indices, bool shift_flag,
            bool rotate_flag);
